...
return (
  ...
  <div className="p-6 pt-24 max-w-xl mx-auto space-y-6">  {/* Detalles del servicio en una línea */}  
...
className="border p-2 w-full rounded"
    onChange={async (e) => {
      ...
      setSubiendoComprobante(true); // ⬅️ mostrar spinner
      setComprobantePago(archivo);

      const url = await subirACloudinary(archivo);

      setSubiendoComprobante(false); // ⬅️ ocultar spinner
      if (url) {
...
<div className="flex flex-col items-center">  
  ...
  {/* Spinner fuera del botón, debajo */}
  {confirmandoReserva && (
    <div className="flex items-center mt-2 space-x-2 text-sm text-gray-600">
      <svg
