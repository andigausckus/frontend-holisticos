    ...
    const slug =  
      ...
      (serv.titulo  
        ? serv.titulo  
            ...
            .replace(/[^a-z0-9\-]/g, "")  
            .replace(/^-+|-+$/g, "")  
        : "sin-titulo");  // Determinar estado visual  
const estaPendiente = !serv.aprobado && serv.estado !== "rechazado";  
...
return (  
  ...
  >  
    ...
    {/* Servicio Rechazado */}  
    {estaRechazado && (  
      <div className="border border-red-300 bg-red-50 p-4 rounded-lg shadow-sm mt-3">  
        <h3 className="text-lg font-semibold text-red-600 line-through">  
          {serv.titulo || "Sin título"}  
        </h3>  
        <p className="text-sm text-gray-600 mt-2">  
          Tu servicio fue rechazado ❌. Podés editarlo y reenviarlo, o eliminarlo si no vas a  
          usar este título, para que otros terapeutas puedan aprovecharlo 🙌  
        </p>  
