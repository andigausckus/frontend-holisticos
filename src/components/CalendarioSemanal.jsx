...
const CalendarioSemanal = ({ disponibilidad, duracionMinutos, onSeleccionar }) => {
  ...
  if (!fechaInicio || !fechaFin) {
    return (
      <p className="text-center text-gray-500">Cargando semana...</p>
    );
  }
          ...
          return (
            ...
            >
              ...
              <p className="text-xs text-center text-gray-500 -mt-1">
                {dia.getDate()} de{" "}
                {dia.toLocaleDateString("es-AR", { month: "long" })}
              </p>
                ...
                <div className="mt-2 flex flex-col gap-1">
                  {rangos.map((rango, idx) => {
                    ...
                    return (
                      <button
                        key={idx}
                        className={`text-sm px-2 py-2 rounded-xl font-medium text-center transition ${
                          estaSeleccionado
                      ...
                      >
                        {formatearHora(rango.desde)} -{" "}
                        {formatearHora(rango.hasta)}
                        <br />
